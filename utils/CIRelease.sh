...
PACKAGES="core cli create-widget integration integration-react integration-custom-element plugin-component plugin-css-scrambler plugin-error plugin-event-emitter plugin-http-client plugin-router plugin-validation tools tool-storybook tool-webpack preact svelte uhtml"
