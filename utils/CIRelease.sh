...
PACKAGES="core create-widget integration integration-react integration-custom-element plugin-component plugin-css-scrambler plugin-error plugin-event-emitter plugin-http-client plugin-router tools tool-storybook tool-webpack preact svelte uhtml"
